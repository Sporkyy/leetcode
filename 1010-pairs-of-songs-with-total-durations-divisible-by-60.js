...
strictEqual(numPairsDivisibleBy60([30, 20, 150, 100, 40]), 3);

strictEqual(numPairsDivisibleBy60([60, 60, 60]), 3);

strictEqual(numPairsDivisibleBy60([20, 40]), 1);
...
strictEqual(numPairsDivisibleBy60([0, 0]), 1);

strictEqual(numPairsDivisibleBy60([0, 0, 0]), 3);

strictEqual(numPairsDivisibleBy60([0, 0, 0, 0]), 6);

strictEqual(numPairsDivisibleBy60([0, 0, 0, 0, 0]), 10);

strictEqual(numPairsDivisibleBy60([0, 0, 0, 0, 0, 0]), 15);
