...
const preorderNested = root => !!!root ? [] : 0 === root.children.length ? [root.val] : [root.val, ...root.children.map(c => preorderNested(c))];
 ...
 * @return {number[]}
 */
const preorder = root => flat(preorderNested(root));
