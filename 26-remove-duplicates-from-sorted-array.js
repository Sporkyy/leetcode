...
// Runtime: 68 ms, faster than 83.57% of JavaScript online submissions
...
// Example 1:
strictEqual(removeDuplicates([1, 1, 2]), 2);
// Your function should return length = 2
// with the first two elements of nums being 1 and 2 respectively.
// It doesn't matter what you leave beyond the returned length.

// Example 2:
strictEqual(removeDuplicates([0, 0, 1, 1, 1, 2, 2, 3, 3, 4]), 5);
